...
| F89 | HIGH | Coherence script + `@editorzero/arch-lint` described as present-tense enforcement, but key checks are stubs and the arch-lint package doesn't exist | Accepted → Applied | 2026-04-18 (pending commit) |
